...
public class MyBloodRequestAdapter extends CursorAdapter{
    ...
    public void bindView(View customView,final Context context, Cursor cursor) {
        ...
        TextView DetailsTextView = (TextView) customView.findViewById(R.id.details_textview);
        LinearLayout DetailsLayout = (LinearLayout) customView.findViewById(R.id.details_layout);
        ...
        String details = cursor.getString(cursor.getColumnIndex(TableBloodRequests.COLUMN_OTHERDETAILS));
